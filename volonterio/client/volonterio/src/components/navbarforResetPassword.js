...
const Navbar2 = ({ navigation, moreNavigation, paths, morePaths}) => {
  ...
  const [newPasswordModalActive, setNewPasswordModalActive] = useState(true); //для встановлення нового паролю
